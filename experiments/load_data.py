...
def get_data(npoints=2000, seed=123, noise=0):
...
def get_datasets(npoints=2000, seed=123, noise=1):
    data_clean_train, data_clean_test, data_clean_train_small = get_data(npoints, seed, 0)
    data_noisy_train, data_noisy_test, data_noisy_train_small = get_data(npoints, seed, noise)
    # Train-test datasets
    datasets_train = [
