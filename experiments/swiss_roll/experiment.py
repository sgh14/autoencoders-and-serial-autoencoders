...
# Plot datasets
plot_original(datasets_train, titles, 'experiments/swiss_roll/results/train_orig')
plot_original(datasets_test, titles, 'experiments/swiss_roll/results/test_orig')
...
plot_projection(datasets_train_red, titles, 'experiments/swiss_roll/results/train_red')
plot_original(datasets_train_rec, titles, 'experiments/swiss_roll/results/train_rec')
plot_projection(datasets_test_red, titles, 'experiments/swiss_roll/results/test_red')
plot_original(datasets_test_rec, titles, 'experiments/swiss_roll/results/test_rec')
...
compute_metrics(
    ...
    datasets_test_rec,
    titles,
    'experiments/swiss_roll/results'
)